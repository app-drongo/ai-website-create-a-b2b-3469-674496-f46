...
import { ArrowRight, BarChart3, TrendingUp, Users, Shield, Clock, Database } from 'lucide-react';
...
export default function Cta() {
  ...
  const stats = [
    ...
    { value: '10TB+', label: 'Daily Processing', icon: Database },
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Join 500+ enterprise clients using Acumen Analytics to unlock real-time insights,
                predictive intelligence, and collaborative decision-making across their
                organizations.
              </p>
              ...
              <div className="text-center mb-12">
                <p className="text-sm text-muted-foreground mb-6">
                  Trusted by Fortune 500 companies and data-driven enterprises
                </p>
        ...
        <div className="text-center mt-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <h3 className="font-semibold">Real-Time Dashboards</h3>
              <p className="text-sm text-muted-foreground">
                Live data visualization with instant insights and alerts
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Shared workspaces and collaborative analytics workflows
              </p>
            </div>
          </div>
        </div>
